...
public class RedBusTicketBooking {
	...
	driver = new RemoteWebDriver((CommandExecutor) new URL("http://localhost:4444/wd/hub"), cap);
	...
	WebElement dateCell = 
	datePicker.findElement(By.xpath("//*[@id=\"onwardCal\"]/div/div/text[2]"));
	dateCell.click();
